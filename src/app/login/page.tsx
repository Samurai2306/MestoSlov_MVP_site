...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-cream via-white to-primary-teal/10 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Войдите, чтобы продолжить путешествие</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-sm font-medium text-primary-teal hover:text-primary-teal/80 transition-colors"
              >
                Забыли пароль?
              </Link>
            </div>
